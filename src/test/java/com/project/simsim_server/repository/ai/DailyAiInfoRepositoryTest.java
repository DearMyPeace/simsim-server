...
//
//    @Test
//    void 기존저장편지및요약_암호화() throws Exception {
//        // given
//        Optional<DailyAiInfo> data = dailyAiInfoRepository.findById(210L);
//
//        // when
//        String summary = null;
//        String reply = null;
...
//
//        // then
//        DailyAiInfo result = dailyAiInfoRepository.findById(210L).get();
//        assertThat(encryptionUtil.decrypt(result.getDiarySummary())).isEqualTo(summary);
//        assertThat(encryptionUtil.decrypt(result.getReplyContent())).isEqualTo(reply);
//    }
//
//    @Test
//    void 암호화문_프론트전달() {
